...
export default function SignupPage({
  ...
  const getFirebaseErrorMessage = (errorCode: string) => {
    switch (errorCode) {
      ...
      case 'auth/operation-not-allowed':
        return 'This signup method is currently disabled. Please try another method.';
      case 'auth/popup-closed-by-user':
        return 'Signup popup was closed. Please try again.';
      case 'auth/popup-blocked':
        return 'Signup popup was blocked by your browser. Please allow popups and try again.';
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      showToast('Successfully signed up with Google! Redirecting...', 'success');
      setTimeout(() => {
        onClose();
        navigate('/dashboard');
      }, 1500);
